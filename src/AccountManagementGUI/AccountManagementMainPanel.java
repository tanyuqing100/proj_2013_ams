...
public class AccountManagementMainPanel extends JPanel {
	...
	public AccountManagementMainPanel(final int id){
		...
		AccountManagementPanel panel = new AccountManagementPanel(id);
		pnl1.add(panel);			
