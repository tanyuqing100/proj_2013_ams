...
private static final long serialVersionUID = 1L;
	...
	private JComboBox<BuildingData> bcSlctBldn;
	
	private JComboBox<Integer> bcRoom; 
	...
	public ManageChangeFeePanel(){
		...
		lay2.add(new JLabel("amount of change"));
		lay2.add(text);
		lay2.add(buttons[0]);
		add(lay2);
			...
			public void mouseClicked(MouseEvent evt){
				...
				try{
					...
					if(amountChange < 0){
						...
						errorMessage = "Change "+ tempBD.getName() +"-"+ tempI + " Fee Success!";
						error = new JTextArea(errorMessage);
					}
				}catch(Exception e){
