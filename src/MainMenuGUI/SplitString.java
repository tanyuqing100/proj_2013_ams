...
/**
 * A class to add "\n" into a string so as to break it up at a blank into lines 
 * of a specific length.  When doing so, blanks at the end of a line (except the 
 * first line) and blanks at the end of a line (except the last one) are removed.
 */
public class SplitString 
{
	/**
	 * Return a String the same as the parameter, except that "\n" is used to divide the
	 * string into lines split at a blank, with blanks on either side of the "\n" removed. 
